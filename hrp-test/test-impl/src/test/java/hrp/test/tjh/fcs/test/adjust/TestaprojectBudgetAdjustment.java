...
public class TestaprojectBudgetAdjustment {
	...
	public Object[][] getExcelData() throws IOException, BiffException {
		...
		sheetName = "TestaprojectBudgetAdjustment";
		Object[][] excelData = ExcelOperation.getExcelData(fileNamePath, sheetName, keyField);
		return excelData;
	}

	@Test(dataProvider = "excelData")
	public void aprojectBudgetAdjustment(HashMap<String, String> excelData) throws Exception {
		...
		desktopDropDownElementService.listFieldCheckButtonSelect(driver, "调增预算", "", increaseBudget);
		// 调减预算
		String loweredBudget = excelData.get("调减预算");
		desktopDropDownElementService.listFieldCheckButtonSelect(driver, "调减预算", "科研业务费", loweredBudget);
		// 调整金额
