...
public class TestPersonalIssues {
	...
	public Object[][] getExcelData() throws IOException, BiffException {
		...
		sheetName = "TestPersonalIssues";
		Object[][] excelData = ExcelOperation.getExcelData(fileNamePath, sheetName, keyField);
		return excelData;
	}

	@Test(dataProvider = "excelData")
	public void personalIssues(HashMap<String, String> excelData) throws Exception {

		// 登录项目经费管理→个人课题信息管理
		LoginMethodServiceImpl loginMethodService = new LoginMethodServiceImpl();
		loginMethodService.loginPage(driver, "项目经费管理", "个人课题信息管理");
		// 新增课题
		// 点击添加
		...
		try {
			...
			logoutMethodService.endPage(driver, "个人课题信息管理");
