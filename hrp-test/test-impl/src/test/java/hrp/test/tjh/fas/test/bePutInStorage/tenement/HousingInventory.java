...
public class HousingInventory {
	...
	public void housingInventory(HashMap<String, String> excelData) throws Exception {
		...
		// String initialAssetValue = excelData.get("资产原值");
		 ...
		 * windowDropdownElementService.listFieldSelect(driver, 1, "查询面板", "资产状态",
		 * assetStates1); // 获取
		 * desktopFormListOperationService.formListClickTarget(driver, "房屋名称",
		 * houseName); // 入库退库 desktopButtonElementService.clickButton(driver, "入库退库");
		 * // 提示-是 windowButtonElementService.clickButton(driver, 1, "提示", "是"); // 资产状态
